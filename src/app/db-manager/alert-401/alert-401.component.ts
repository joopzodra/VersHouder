 ...
 * A 401 http-error in de DbManager can occur on rare occassions, when the user session is terminated but the usern doesn't navigate away. For example: he has an edit form open, stops working for an hour and then resumes and submits the form to the backend. Or starts a search with the ForeignKeySearchComponent.
 */
